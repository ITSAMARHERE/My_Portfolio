        ...
        <section className="relative bg-transparent text-white mt-12 flex flex-col justify-center">
            ...
            <div className="fixed left-10 bottom-0 hidden lg:block">
                <div className="flex flex-col items-center">
                    ...
                    <Link href="https://drive.google.com/file/d/1osKgLxcVYkK2or9yUW-lwX5kMMPufvKk/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="p-3 text-foreground hover:scale-150 transition-all">
                        <FileUser size={20} />   
                    </Link>
